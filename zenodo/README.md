# Encuesta breve — destino previsto: Zenodo

Prototipo de encuesta jsPsych en español conectado a DataPipe con destino a
Zenodo. El experimento usa el ID `o4LL1OtDf9XZ` y guarda una sesión por
...
nombre ni correo electrónico. La pantalla de consentimiento y el debrief deben
revisarse con los datos del equipo responsable y el protocolo final antes de
